...
class Sozcuk {
    ...
    private function ek_getir($ek) {
        ...
        switch ($ek) {
            ...
            case '-dahi':       return $kelime . ($si ? ' de' : ' da');
...
class WordEngine {
    ...
    public function ezberdenAl($tip, $liste) {
        ...
        switch ($tip) {
            case $tip == WordTypes::kfiil: $table = "w_kfiiller";
                break;
            case $tip == WordTypes::isim: $table = "w_isimler";
                break;
            case $tip == WordTypes::sifat: $table = "w_sifatlar";
                break;
            case $tip == WordTypes::edat: $table = "w_edatlar";
                break;
            default: $table = "w_isimler";
                FB::error($tip, "Kelime yok");
        }
    ...
    public function sacmala($migirSablon, $yurut = true) {
        ...
        foreach ($ogeler as $oge)
            $yogunluk[$oge['oge']] = isset($yogunluk[$oge['oge']]) ? $yogunluk[$oge['oge']] + 1 : 1;
